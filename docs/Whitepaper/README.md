...
2.When the number of miners is 5001-1000,=(Current number of miners)/5000.

...

3.When the number of miners is greater or equal to 75,000，(Reaching the extreme).
...
https://drive.google.com/file/d/18pdIs5HXRc4NW4MhTE5SjOQATuV_oZPV/view?usp=sharing
## 10. Roadmap
