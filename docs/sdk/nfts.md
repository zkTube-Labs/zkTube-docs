...
This API reference provides descriptions for all functions regarding NFTs in zkTube 1.x.
 <!-- It is recommended that you
begin with our [NFT tutorial](/dev/nfts.md) and come back here to reference specific functions. -->

- [NFTs](#nfts)
  - [Connect to the Rinkeby testnet](#connect-to-the-rinkeby-testnet)
  - [Mint NFT](#mint-nft)
...
```typescript
const contentHash = '0x2733b749e4918855bcba0747f7aa66202e924f3af75f5ef87607d81cbf00107a';
...
[API reference](./accounts.md#swaps-in-zktube).
...
In case of censorship, users may call for an emergency withdrawal.
 <!-- Note: This is a layer 1 operation, and is analogous
